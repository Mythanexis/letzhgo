...
const WERDEGANG = [
  ...
  { year: "2017", text: "Fahrlehrer mit eidg. Fachausweis" },
    ...
    <section className="mx-auto max-w-7xl px-6 pt-32 pb-20 md:px-16">
      ...
      <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
        <div className="lg:col-span-3">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} className="mt-10">
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-foreground">Fahrlehrer für Auto, Motorrad und Anhänger, Theorielehrer für Verkehrskunde und Nothelfer</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Geburtstag</p>
                <p className="mt-2 text-foreground">31.01.1990</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Hobbys</p>
                <p className="mt-2 text-foreground">Schwimmen, Motorrad, Arbeiten</p>
              </div>
              <div>
          ...
          <div className="mt-12">
            <div className="w-44">
              <Image src="/images/qr-tomi.png" alt="QR Code Tomi Caleta" width={200} height={200} className="w-full" />
            </div>
