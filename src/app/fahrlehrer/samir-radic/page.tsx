...
const WERDEGANG = [
  { year: "2014", text: "Ausbildung zum Motorradfahrlehrer" },
  { year: "2013", text: "SVEB-zertifizierter Erwachsenenbildner" },
    ...
    <section className="mx-auto max-w-7xl px-6 pt-32 pb-20 md:px-16">
      ...
      <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
        <div className="lg:col-span-3">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} className="mt-10">
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-foreground">Fahrlehrer für Auto und Motorrad, Theorielehrer für Verkehrskunde</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Geburtstag</p>
                <p className="mt-2 text-foreground">30.08.1971</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Hobbys</p>
                <p className="mt-2 text-foreground">Tauchen, Fahrrad, Motorrad, Arbeiten</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Kontakt</p>
                <a href="tel:+41788888899" className="mt-2 block text-foreground hover:text-accent transition-colors">+41 78 888 88 99</a>
              </div>
              <div>
            ...
            <a href="https://wa.me/41788888899" target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1fb855]">
          ...
          <div className="mt-12">
            <div className="w-44">
              <Image src="/images/qr-samir.png" alt="QR Code Samir Radič" width={200} height={200} className="w-full" />
            </div>
