...
const WERDEGANG = [
  { year: "2018", text: "Fahrlehrer mit eidg. Fachausweis" },
  { year: "2017 – 2018", text: "Ausbildung zum Fahrlehrer bei fai Fahrlehrer Ausbildungsinstitut Zürich" },
  { year: "2012 – 2018", text: "Kaufmännischer Angestellter bei Paul Forrer AG, Bergdietikon" },
  { year: "2010 – 2011", text: "Militärdienst" },
  { year: "2010 – 2012", text: "Kaufmännischer Angestellter bei Reto Hartmann Treuhand AG, Winterthur" },
  { year: "2008 – 2010", text: "Dr. Reaners Höhere Handelsschule, Zürich" },
      ...
      <div className="grid gap-12 lg:grid-cols-5 lg:gap-16">
        <div className="lg:col-span-3">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2 }}>
            <h1 className="text-4xl font-bold text-foreground md:text-5xl">Doma Caleta</h1>
            <p className="mt-3 text-lg text-muted">Fahrlehrer für Auto, Verkehrskundelehrer</p>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} className="mt-10">
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-foreground">Fahrlehrer für Auto, Verkehrskundelehrer</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Hobbys</p>
                <p className="mt-2 text-foreground">Motorrad, Auto, Fischen, Arbeiten</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Kontakt</p>
                <a href="tel:+41793388032" className="mt-2 block text-foreground hover:text-accent transition-colors">+41 79 338 80 32</a>
              </div>
            </div>

            <a href="https://wa.me/41793388032" target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1fb855]">
          ...
          <div className="mt-12">
            <div className="w-44">
              <Image src="/images/qr-doma.png" alt="QR Code Doma Caleta" width={200} height={200} className="w-full" />
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, delay: 0.3 }} className="lg:col-span-2">
          <div className="lg:sticky lg:top-28">
            <div className="overflow-hidden rounded-2xl">
              <Image src="/images/doma-portrait.png" alt="Doma Caleta" width={600} height={400} className="w-full object-cover" priority />
            </div>
          </div>
        </motion.div>
      </div>
