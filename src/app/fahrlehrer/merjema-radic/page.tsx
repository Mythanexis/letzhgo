...
const WERDEGANG = [
  { year: "2023", text: "Fahrlehrerin mit eidg. Fachausweis" },
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }} className="mt-10">
            <div className="grid gap-6 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-2 text-foreground">Fahrlehrerin für Auto, Nothelferinstruktorin, Theorielehrerin für Verkehrskunde</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Geburtstag</p>
                <p className="mt-2 text-foreground">03.06.1998</p>
              </div>
              <div>
                <p className="text-sm font-medium uppercase tracking-widest text-accent">Hobbys</p>
                <p className="mt-2 text-foreground">Tauchen, Reisen, Arbeiten</p>
              </div>
              <div>
            ...
            <a href="https://wa.me/41768156688" target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2.5 rounded-full bg-[#25D366] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#1fb855]">
